    ...
    return (
        <ModPage modInfo={projectNublarInfo}>
            ...
            <section className="mt-10">
                ...
                <p className="text-neutral-500">DumbCode plans to release a single beta for Project Nublar for Neo/Forge/Fabric 1.20.1, after which all development will move to the latest version of each loader.<br />No dates have been set for release or the beta.</p>
            </section>
